...
## GETTING ROW_KEY
#@get_row_key=`cat attempt_1463076948844_172053_r_000022_0 |grep "Hbase scan"|awk '{print \$9}'|awk -F ":" '{print \$2}'`;
@get_row_key=`cat attempt_1463076948844_172053_r_000022_0 |grep "Hbase scan"|awk '{print \$1,\$2,\$9}'`;
chomp(@get_row_key);
@get_region_server= `cat hbase-hbase-master-lvshdc5en0004.lvs.paypal.com.log|grep Onlined|awk '{print \$1,\$2,\$7,\$9}'`;
